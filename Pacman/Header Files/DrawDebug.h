...
public:
    ...
    static sf::RectangleShape DrawCell(const sf::Vector2f cellWorldPosition, const float cellSize = CELL_SIZE, const sf::Color& color = sf::Color::White);
    void DrawCellPersistant(const sf::Vector2f cellWorldPosition, const float cellSize = CELL_SIZE, const sf::Color& color = sf::Color::White) { mDrawRectangleShapes.push_back(DrawCell(cellWorldPosition, cellSize, color)); }
